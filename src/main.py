...
def main(config):
    ...
    if (config['task'] == "classification") or (config['task'] == "regression"): 

        model, _, _ = utils.load_model(model, os.path.join(config['save_dir'], 'model_best.pth'), optimizer, config['resume'],
                                                         False,
                                                         config['lr'],
                                                         config['lr_step'],
                                                         config['lr_factor'])
